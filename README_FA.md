...
یک موتور یکپارچه برای مناسبت‌ها و تعطیلات تقویم‌های شمسی، هجری قمری و میلادی — با داده‌های دوزبانه (فارسی و انگلیسی)، دسته‌بندی تعطیلات رسمی، و پشتیبانی از مناسبت‌های ثابت، چند‌روزه و متغیر.
